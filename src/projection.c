...
// Function to map NDC to screen coordinates: (x, y, _z, _w) -> (screen_x, screen_y)
...
// Function to perform perspective divide on transformed vertices: (x, y, z, w) -> (x/w, y/w, z/w, 1)
